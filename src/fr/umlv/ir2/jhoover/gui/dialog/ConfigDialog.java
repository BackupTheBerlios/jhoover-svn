...
public class ConfigDialog extends AbstractDialog {
	...
	//fields
	private JTextField rProjectName;
	private JTextField rUrl;
	private JSpinner rDepth;
	private JTextField rRegexp;
	private JSpinner rNbHtmlThread;
	private JSpinner rNbLinkedThread;
	private JTextField rDestDirectory;
	...
	public ConfigDialog(String title) {
		...
		buildPanel(createHeaderPanel(), createFieldPanel(), createButtonPanel());
	}
	...
	private JPanel createFieldPanel() {
		...
		chooseDestDirectory.addActionListener (new ActionListener() {
			public void actionPerformed (ActionEvent e) {
				...
				int returnVal = fileChooser.showDialog (ConfigDialog.this , null);
	...
	private JPanel createButtonPanel() {
		...
		buttonOk.addActionListener(okButtonAction());
		
		//Cancel Button
		JButton buttonCancel = new JButton("Cancel");
		buttonCancel.addActionListener(cancelButtonAction());
