 ...
 *
 */
public class CopyOfConfigDialog extends JDialog {
	//Configuration of jHoover
	JHooverConfiguration configuration;
	
	public CopyOfConfigDialog(String title) {
		super(JHMainFrame.getInstance(), title, true);
		setdesign();
	...
	private void addPanels() {
		...
		chooseDestDirectory.addActionListener (new ActionListener() {
			public void actionPerformed (ActionEvent e) {
				...
				int returnVal = fileChooser.showDialog (CopyOfConfigDialog.this , null);
