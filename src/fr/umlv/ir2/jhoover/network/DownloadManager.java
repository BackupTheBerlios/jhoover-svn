...
public class DownloadManager extends Thread {
    ...
    /**
     * Thread to download files Take all the webLinkedFile contained in the
     * htmlFileToDownload list and download them
     */
    public void run() {
        testIfPaused();
    ...
    /**
     * Add a webHtmlFile in the queue if it hasn't been already downloaded and
     * if it respect the good host or protocol
     * 
    ...
    /**
     * Add a webLinkedFile in the queue if it hasn't been already downloaded and
     * if it respect the good host or protocol
     * 
     * @param uri the URI to add
     * @param depth the depth of the URI
     ...
     * @return true if the file has already been downloaded or if we should not
     * try to download it, else false
     */
    ...
    private void createJTree() {
        ...
        tree.addTreeSelectionListener(new TreeSelectionListener() {
            public void valueChanged(TreeSelectionEvent arg0) {
                // TODO: faire l'action pour aller selectionner la ligne dans la
                // JTable
